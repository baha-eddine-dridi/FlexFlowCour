...
import 'cour_membre_copy_model.dart';
export 'cour_membre_copy_model.dart';

class CourMembreCopyWidget extends StatefulWidget {
  const CourMembreCopyWidget({super.key});

  @override
  State<CourMembreCopyWidget> createState() => _CourMembreCopyWidgetState();
}

class _CourMembreCopyWidgetState extends State<CourMembreCopyWidget> {
  late CourMembreCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CourMembreCopyModel());
                        ...
                        Padding(
                          ...
                          child: StreamBuilder<List<CoursRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CoursRecord> choiceChipsCoursRecordList =
                                  snapshot.data!;
                              return FlutterFlowChoiceChips(
                                options: choiceChipsCoursRecordList
                                    .map((e) => e.categorie)
                                    .toList()
