...
import 'cour_membre_model.dart';
export 'cour_membre_model.dart';

class CourMembreWidget extends StatefulWidget {
  const CourMembreWidget({super.key});

  @override
  State<CourMembreWidget> createState() => _CourMembreWidgetState();
}

class _CourMembreWidgetState extends State<CourMembreWidget> {
  late CourMembreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CourMembreModel());
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 31.0, 0.0),
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            Padding(
